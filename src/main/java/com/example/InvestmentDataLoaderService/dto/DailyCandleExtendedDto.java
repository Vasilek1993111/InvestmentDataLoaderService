...
/**
 * Расширенный DTO для дневных свечей с дополнительной статистикой
 */
public record DailyCandleExtendedDto(
        @JsonProperty("figi")
        String figi,
     ...
     */
    public static DailyCandleExtendedDto fromBasicData(String figi, String ticker, String name, 
        ...
        BigDecimal averagePrice = high.add(low).add(close).divide(BigDecimal.valueOf(3), 2, java.math.RoundingMode.HALF_UP);
