...
public class CandlesDailyController {
    ...
    private static final Logger log = LoggerFactory.getLogger(CandlesDailyController.class);
    ...
    public ResponseEntity<Map<String, Object>> loadDailyCandlesTodayAsync(@RequestBody(required = false) DailyCandleRequestDto request) {
        ...
        try {
            log.info("Запуск загрузки дневных свечей за сегодня, taskId: {}", taskId);
            ...
            log.error("Ошибка запуска асинхронной загрузки дневных свечей: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> loadDailyCandlesForDateAsync(
        ...
        try {
            log.info("Запуск загрузки дневных свечей за дату {}, taskId: {}", date, taskId);
            ...
            log.error("Ошибка запуска асинхронной загрузки дневных свечей за дату: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> getSharesDailyCandlesForDate(
        ...
        try {
            log.info("Получение дневных свечей акций за дату {}, taskId: {}", date, taskId);
            ...
            for (ShareEntity share : shares) {
                ...
                try {
                    // Получаем дневные свечи из API (без логирования каждого инструмента)
            ...
            if (!allCandles.isEmpty()) {
                ...
                response.put("averagePrice", avgPrice);
                        ...
                        log.info("Завершение получения дневных свечей акций, taskId: {}, инструментов: {}, свечей: {}", taskId, shares.size(), totalCandles);
            ...
            return ResponseEntity.ok(response);
                        ...
                        log.error("Ошибка получения дневных свечей акций: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> loadSharesDailyCandlesForDateAsync(
        ...
        try {
            log.info("Запуск загрузки дневных свечей акций за дату {}, taskId: {}", date, taskId);
            ...
            return ResponseEntity.accepted().body(response);
                        ...
                        log.error("Ошибка запуска асинхронной загрузки дневных свечей акций: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> loadFuturesDailyCandlesForDateAsync(
        ...
        try {
            log.info("Запуск загрузки дневных свечей фьючерсов за дату {}, taskId: {}", date, taskId);
            ...
            return ResponseEntity.accepted().body(response);
                        ...
                        log.error("Ошибка запуска асинхронной загрузки дневных свечей фьючерсов: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> getFuturesDailyCandlesForDate(
        ...
        try {
            log.info("Получение дневных свечей фьючерсов за дату {}, taskId: {}", date, taskId);
            ...
            if (!allCandles.isEmpty()) {
                ...
                response.put("averagePrice", avgPrice);
                        ...
                        log.info("Завершение получения дневных свечей фьючерсов, taskId: {}, инструментов: {}, свечей: {}", taskId, futures.size(), totalCandles);
            ...
            return ResponseEntity.ok(response);
                        ...
                        log.error("Ошибка получения дневных свечей фьючерсов: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> loadIndicativesDailyCandlesForDateAsync(
        ...
        try {
            log.info("Запуск загрузки дневных свечей индикативов за дату {}, taskId: {}", date, taskId);
            ...
            return ResponseEntity.accepted().body(response);
                        ...
                        log.error("Ошибка запуска асинхронной загрузки дневных свечей индикативов: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> getIndicativesDailyCandlesForDate(
        ...
        try {
            log.info("Получение дневных свечей индикативов за дату {}, taskId: {}", date, taskId);
            ...
            if (!allCandles.isEmpty()) {
                ...
                response.put("averagePrice", avgPrice);
                        ...
                        log.info("Завершение получения дневных свечей индикативов, taskId: {}, инструментов: {}, свечей: {}", taskId, indicatives.size(), totalCandles);
            ...
            return ResponseEntity.ok(response);
                        ...
                        log.error("Ошибка получения дневных свечей индикативов: " + e.getMessage());
