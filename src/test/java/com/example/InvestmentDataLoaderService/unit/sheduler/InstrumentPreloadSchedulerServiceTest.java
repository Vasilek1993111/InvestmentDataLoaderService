...
public class InstrumentPreloadSchedulerServiceTest {
    ...
    private List<ShareDto> createTestShares() {
        return Arrays.asList(
            new ShareDto("BBG004730N88", "SBER", "Сбербанк", "RUB", "moex_mrng_evng_e_wknd_dlr", "Financials", "SECURITY_TRADING_STATUS_NORMAL_TRADING"),
            new ShareDto("BBG004730ZJ9", "GAZP", "Газпром", "RUB", "moex_mrng_evng_e_wknd_dlr", "Energy", "SECURITY_TRADING_STATUS_NORMAL_TRADING"),
            new ShareDto("BBG004730N88", "LKOH", "Лукойл", "RUB", "moex_mrng_evng_e_wknd_dlr", "Energy", "SECURITY_TRADING_STATUS_NORMAL_TRADING")
        );
    }

    private List<FutureDto> createTestFutures() {
        return Arrays.asList(
            new FutureDto("FUTSBER0324", "SBER-3.24", "COMMODITY", "SBER", "RUB", "moex"),
            new FutureDto("FUTGAZP0324", "GAZP-3.24", "COMMODITY", "GAZP", "RUB", "moex"),
            new FutureDto("FUTLKOH0324", "LKOH-3.24", "COMMODITY", "LKOH", "RUB", "moex")
        );
    }
    ...
    private List<ShareDto> createLargeSharesList(int count) {
        return Arrays.asList(new ShareDto[count]).stream()
            .map(i -> new ShareDto("BBG" + i, "TICKER" + i, "Name" + i, "RUB", "moex_mrng_evng_e_wknd_dlr", "Sector", "STATUS"))
            .toList();
    }

    private List<FutureDto> createLargeFuturesList(int count) {
        return Arrays.asList(new FutureDto[count]).stream()
            .map(i -> new FutureDto("FUT" + i, "TICKER" + i, "COMMODITY", "ASSET" + i, "RUB", "moex"))
            .toList();
    }
    ...
    private List<ShareDto> createSharesWithNullFields() {
        return Arrays.asList(
            new ShareDto(null, "SBER", "Сбербанк", "RUB", "moex_mrng_evng_e_wknd_dlr", "Financials", "STATUS"),
            new ShareDto("BBG004730N88", null, "Газпром", "RUB", "moex_mrng_evng_e_wknd_dlr", "Energy", "STATUS"),
            new ShareDto("BBG004730N88", "LKOH", null, "RUB", "moex_mrng_evng_e_wknd_dlr", "Energy", "STATUS")
        );
    }

    private List<FutureDto> createFuturesWithNullFields() {
        return Arrays.asList(
            new FutureDto(null, "SBER-3.24", "COMMODITY", "SBER", "RUB", "moex"),
            new FutureDto("FUTGAZP0324", null, "COMMODITY", "GAZP", "RUB", "moex"),
            new FutureDto("FUTLKOH0324", "LKOH-3.24", null, "LKOH", "RUB", "moex")
        );
    }
